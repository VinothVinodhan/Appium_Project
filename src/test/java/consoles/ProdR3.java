...
public class ProdR3 {
	...
	// Guide in mobile
	By Guidelist = By.id("tutorial_list");
	By firstguide = By.xpath(
			"/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.webkit.WebView/android.webkit.WebView/android.view.View[2]/android.view.View[3]/android.view.View[2]/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[1]/android.view.View/android.widget.ListView/android.view.View[1]/android.view.View[1]");
	By openguide = By.xpath(
	...
	public void startReport() {
		...
		report = new ExtentReports("C:\\Users\\manju\\Desktop\\Aetherpal\\Automation Final\\report.html");
	...
	@Test
	public void healCheck() throws InterruptedException, IOException, AWTException {
		...
		XSSFSheet SH = Wb.getSheet("prodr3");
		...
		logger.log(LogStatus.INFO, "Enrolling with given tenant id");
		Thread.sleep(50000);
		System.out.println("50 sec waited");
		logger.log(LogStatus.INFO, "Enrollment completed");
		...
		FileUtils.copyFile(MobSS1, new File("D:\\Automation\\ScreenShots\\ProdR3\\Mobile_GuideMe.png"));
		System.out.println("Mobile GuideMe page SS taken");
		
		
		File src = ((TakesScreenshot) driver1).getScreenshotAs(OutputType.FILE);
		String fname = "D:\\Automation\\ScreenShots\\ProdR3\\Mobile_GuideMe.png";
		FileUtils.copyFile(src, new File(fname));
		String image = logger.addScreenCapture(fname);
		...
		FileUtils.copyFile(MobSS3, new File("D:\\Automation\\ScreenShots\\ProdR3\\Mobile_About.png"));
		...
		FileUtils.copyFile(MobSS2, new File("D:\\Automation\\ScreenShots\\ProdR3\\Mobile_RC.png"));
		...
		FileUtils.copyFile(ConsoleSS1, new File("D:\\Automation\\ScreenShots\\ProdR3\\Search BLock.png"));
		...
		FileUtils.copyFile(ConsoleSS2, new File("D:\\Automation\\ScreenShots\\ProdR3\\Console PIN.png"));
		...
		try {
			...
			FileUtils.copyFile(MobSS6, new File("D:\\Automation\\ScreenShots\\ProdR3\\Mobile_RC_Disconnect.png"));
		...
		FileUtils.copyFile(src1, new File("D:\\Automation\\ScreenShots\\ProdR3\\RC Landing Page.png"));
		...
		FileUtils.copyFile(MobSS7, new File("D:\\Automation\\ScreenShots\\ProdR3\\Mobile_FMToast.png"));
		...
		FileUtils.copyFile(ConsoleSS3, new File("D:\\Automation\\ScreenShots\\ProdR3\\FM Landing Page.png"));
		...
		driver.close();
		System.out.println("Prodr3 check is Completed. Now closing the console");
	...
	public void ScreenShot(ITestResult res) throws IOException {
		if (!res.isSuccess()) {
			...
			FileUtils.copyFile(Console, new File("D:\\Automation\\ScreenShots\\ProdR3\\ProdR3_Failed_Console.png"));
			...
			FileUtils.copyFile(Device, new File("D:\\Automation\\ScreenShots\\ProdR3\\ProdR3_Failed_Device.png"));
