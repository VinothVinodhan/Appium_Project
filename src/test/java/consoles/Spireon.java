...
public class Spireon {
	...
	public void healCheck() throws InterruptedException, IOException {
		...
		XSSFSheet SH = Wb.getSheet("spireon");
		...
		FileUtils.copyFile(MobSS1, new File("D:\\Automation\\ScreenShots\\spireon\\Mobile_GuideMe.png"));
		...
		FileUtils.copyFile(MobSS3, new File("D:\\Automation\\ScreenShots\\spireon\\Mobile_About.png"));
		...
		FileUtils.copyFile(MobSS2, new File("D:\\Automation\\ScreenShots\\spireon\\Mobile_RC.png"));
		...
		FileUtils.copyFile(ConsoleSS1, new File("D:\\Automation\\ScreenShots\\spireon\\Search BLock.png"));
		...
		System.out.println("You are running an Unattended tenant");
		Thread.sleep(5000);

		// Take RC page SS after making RC
		try {
			File MobSS6 = ((TakesScreenshot) driver1).getScreenshotAs(OutputType.FILE);
			FileUtils.copyFile(MobSS6, new File("D:\\Automation\\ScreenShots\\spireon\\Mobile_RC_Disconnect.png"));
			System.out.println("Mobile RC with Disconnect page SS taken");
		} catch (Exception e) {
			System.out.println("Mobile RC page ss not taken");
		}
		...
		FileUtils.copyFile(src1, new File("D:\\Automation\\ScreenShots\\spireon\\RC Landing Page.png"));
		...
		FileUtils.copyFile(src2, new File("D:\\Automation\\ScreenShots\\spireon\\FM Landing Page.png"));
		...
		driver.close();
		System.out.println("Spireon check is Completed. Now closing the console");
	}
	...
	public void ScreenShot(ITestResult res) throws IOException {
		if (!res.isSuccess()) {
			...
			FileUtils.copyFile(Console, new File("D:\\Automation\\ScreenShots\\spireon\\Spireon_Failed_Console.png"));
			...
			FileUtils.copyFile(Device, new File("D:\\Automation\\ScreenShots\\spireon\\Spireon_Failed_Device.png"));
