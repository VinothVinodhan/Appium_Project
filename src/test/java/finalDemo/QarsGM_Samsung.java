...
public class QarsGM_Samsung {
	...
	public void Device() throws InterruptedException, IOException {
		...
		System.out.println("Waiting for 3 second to get login page");
		Thread.sleep(3000);
		...
		FileUtils.copyFile(MobSS6, new File("D:\\Automation\\ScreenShots\\Mobile_FM_Permission.png"));
		...
		FileUtils.copyFile(MobSS7, new File("D:\\Automation\\ScreenShots\\Mobile_CL_Permission.png"));
